...
object DependencyManagement {
  ...
  def ScalazEffect = "org.scalaz" %% "scalaz-effect" % "7.1.0"
   ...
   */
  def Specs = "org.specs2" %% "specs2" % "2.4.6" % "test" intransitive()
   ...
   */
  def Scalacheck = "org.scalacheck" %% "scalacheck" % "1.11.6" % "test"
